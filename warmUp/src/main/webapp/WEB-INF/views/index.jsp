...
<body>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                <a class="navbar-brand" href="#!">Hello Yu ju :)</a>
                <a class="btn btn-primary" href="memberJoinView.me">회원가입</a>
            </div>
        </nav>
        <!-- Masthead-->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">Email Me! if you contect me!</h1>
                            <!-- Signup form-->
                            <!-- * * * * * * * * * * * * * * *-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                            ...
                            <h3>About Me</h3>
                            <p class="lead mb-0">Skils,certificate, Foreign language... </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid p-0">
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                        <h2>PPT,PPTX,DOC,DOCX to PDF</h2>
                        <p class="lead mb-0">try convert ppt, pptx, doc, docx to pdf!</p>
                    </div>
                </div>
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 my-auto showcase-text">
                        <h2>Toy</h2>
                        <p class="lead mb-0">Just My toy project!</p>
                    </div>
                </div>
                <div class="row g-0">
